...
import { AuthResponse, LoginCredentials, RegisterData, Sweet } from '../types';
...
export const sweetsAPI = {
  ...
  create: async (data: Omit<Sweet, 'id' | 'created_at' | 'updated_at'>): Promise<Sweet> => {
    const response = await api.post('/sweets', data);
    return response.data;
  },

  update: async (id: string, data: Partial<Sweet>): Promise<Sweet> => {
